...
// });
// admission.save();
app.post("/admission", async (req, res, next) => {
    try {
...
app.post("/adminchange", async (req, res, next) =>  {
    try{
...
app.post("/adminchangeatt", async (req, res, next) => {
    try{
        var roll_number = req.body.roll;
...
app.post("/adminchangetestquestion", async (req, res, next) => {
    try{
        Admission.find(function (err, admissions) {
            if (err) {
                console.log(err);
...
app.post("/adminchangenotes", async (req, res, next) => {
    try{
        Admission.find(function (err, admissions) {
            if (err) {
                console.log(err);
